...
public class StreamBasics {
	...
	public static void main(String[] args) {
		...
		Stream<Integer> stream=Stream.of(10,20,30,40,50,60,70);//Returns a sequential ordered stream whose elements are the specified
...
stream=stream.map(m->m*m);
		stream.forEach(System.out::println);//print
		// limit 
